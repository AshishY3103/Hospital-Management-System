        ...
        <div class="col-md-12">
                                ...
                                if(($_POST['fname']=="") ||( $_POST['lname']=="" )||($_POST['username'] == "") ||($_POST['email']=="" )||($_POST['phone_no']=="" )||($_POST['gender'] == "") || ($_POST['password'] == "") || ($_POST['cpassword'] == "")||($_POST['country'] == "")){
                                    ...
                                    if(empty($filename)){
                                       $error['d']="Choose a photo for profile";
                                        ...
                                        $query = " INSERT into patients(fname,lname,username,email,phone_no,gender,password,country,date_reg,profile) values('$fname','$lname','$username','$email','$phone_no','$gender','$password','$country',NOW(),'$destfile')";                                    
            ...
            <div class="col-md-2"></div>
                ...
                <div class="col-md-3">
                    ...
                    <input  type="Submit" name="create_account" class="btn btn-warning " value="Register">  
