...
<body>
    <?php 
        ...
        include 'db/config.php';
            $d = $_SESSION['doctor'];
            $query = "SELECT * FROM doctors WHERE username = '$d'";
                                ...
                                if (isset($_POST['update'])){
                                    ...
                                    if(empty($filename)){
                                       $error['profile']="Choose a photo for profile";
                                        ...
                                        $query="UPDATE doctors SET profile = '$destfile' WHERE id='$id'";
                                        $result=mysqli_query($con,$query);
                                 ...
                                 <?php  
                                        ...
                                        if (isset($_POST['updateuname'])){
                                            ...
                                            if(empty($username)){
                                                ...
                                                $query="UPDATE doctors SET username = '$username' WHERE id=$id";
                                                $result=mysqli_query($con,$query);
                                                if($result){
                                                    echo "<script>";
                                ...
                                if(isset($_POST['chpassword'])){
                                    ...
                                    if(empty($opassword) || empty($npassword) || empty($cpassword)){
                                        ...
                                        if($opassword == $password){
                                            $query="UPDATE doctors SET password= '$npassword' WHERE id='$id'";
                                            $result=mysqli_query($con,$query);
                                            if($result){
